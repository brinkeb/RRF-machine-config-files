...
M550 P"Caribou 320b"                                          ; Set printer name
...
; M906 X620.00 Y800.00 Z560.00 E650.00 I10.                ; Set motor currents (mA) and motor idle factor in percent
...
M906 X1200.00 Y1200.00 Z550.00 E550.00 I50                 ; Set initial motor currents (mA) and motor idle factor in percent
M84 S30                                                   ; Set idle timeout before shifitng to idle-current  
...
G31 X-24.3 Y-34.1 Z2.03                                    ; BLTouch, Z offset with MICRO SWISS NOZZLE
M574 Z1 S2                                                 ; Set Z axis endstop, controlled by probe
M557 X25:225 Y-10:170 P2                                    ; Define mesh grid for probing
...
M307 H0 A169.3 C490.9 D9.0 S1.00 V24.0 B0
M140 H0                                                    ; Bed uses Heater 0
M143 H0 S110                                               ; Set temperature limit for heater 0 to 120C Bed

; Filament Sensor
M591 D0 P2 C"e0stop" S1                                    ; Filament Runout Sensor  

; HotEnd Heaters and Thermistor HotEnd
M308 S1 P"e0_temp" Y"thermistor" A"Nozzle" T100000 B4138 R4700  ; Set thermistor + ADC parameters for heater 1 HotEnd
;M308 S1 P"e0_temp" Y"pt1000" A"Mosquito"                   ; Set extruder thermistor for PT1000
M950 H1 C"e0heat" T1                                       ; Create HotEnd Heater
;M307 H1 A330.0 C100.7 D4.9 S1.00 V24.2 B0                  ; Hotend PID Calibration @ 240c - updated 09AUG2020
M307 H1 A433.8 C136.2 D4.5 S1.00 V24.2 B0
...
; Fans
M950 F1 C"Fan1" Q500                                      ; Creates HOTEND Fan  
                                                           ; FAN 40X10MM 24VDC - 6.0 CFM (0.168m³/min). 
                                                           ; Digi-Key: G4010L24B-RSR  
M106 P1 S255 H1 T45                                     ; HOTEND Fan Settings  
M950 F0 C"Fan0" Q500                                     ; Creates PARTS COOLING FAN
                                                           ; BLOWER 50X15MM 24VDC - 5.0 CFM (0.140m³/min)
                                                           ; Digi-Key: B5015E24B-BSR
M106 P0 S0 H-1                                                ; Set fan 1 value, PWM signal inversion and frequency. Thermostatic control is turned off PARTS COOLING FAN
